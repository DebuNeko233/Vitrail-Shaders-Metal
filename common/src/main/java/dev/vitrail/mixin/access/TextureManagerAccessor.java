 ...
 * backend keeps it only while its debug validation is on: {@code MetalDevice} stores the
 * empty string otherwise, and this engine runs against a device that has that off. Reading the
