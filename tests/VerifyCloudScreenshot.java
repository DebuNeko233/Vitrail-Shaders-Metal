...
/** Developer-only pixel verifier for the PHASE 7 cloud fixture. */
public final class VerifyCloudScreenshot {
    private VerifyCloudScreenshot() {
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 1) {
            System.err.println("Usage: java tests/VerifyCloudScreenshot.java <minecraft-screenshot.png>");
            System.exit(2);
        }
        ...
        System.out.println("Cloud screenshot swatches: GREEN=" + counts.green()
                + " MAGENTA=" + counts.magenta() + " greenMinimum=" + counts.greenMinimum());
        if (!counts.passes()) {
            throw new AssertionError("Expected a visible green cloud region and no substantial magenta CloudInfo/CloudFaces ABI failure region");
        }
        System.out.println("Cloud screenshot routing/vertex-ABI colour check: PASS");
    }
    ...
    private static void selfTest() {
        ...
        fill(pass, 65, 45, 415, 210, 0xFF00CC00);
        ...
        fill(fail, 65, 45, 415, 210, 0xFFFF00FF);
        ...
        if (absent.passes()) throw new AssertionError("Verifier missing-cloud self-test unexpectedly passed: " + absent);

        System.out.println("Cloud screenshot verifier self-test: PASS " + good);
    }
