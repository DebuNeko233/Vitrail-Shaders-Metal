...
/** Developer-only pixel verifier for the PHASE 7 camera armor-glint fixture. */
public final class VerifyArmorGlintScreenshot {
    private VerifyArmorGlintScreenshot() {
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 1) {
            System.err.println("Usage: java tests/VerifyArmorGlintScreenshot.java <minecraft-screenshot.png>");
            System.exit(2);
        }
        ...
        System.out.println("Armor-glint screenshot swatches: GREEN=" + counts.green()
                + " MAGENTA=" + counts.magenta() + " greenMinimum=" + counts.greenMinimum());
        if (!counts.passes()) {
            throw new AssertionError("Expected a visible green camera armor-glint layer and no substantial magenta synthesized-input failure region");
        }
        System.out.println("Armor-glint screenshot routing/vertex-ABI colour check: PASS");
    }
    ...
    private static void selfTest() {
        ...
        fill(pass, 215, 125, 265, 175, 0xFF00CC00);
        ...
        fill(fail, 215, 125, 265, 175, 0xFFFF00FF);
        ...
        if (absent.passes()) {
            throw new AssertionError("Verifier missing-glint self-test unexpectedly passed: " + absent);
        }
        System.out.println("Armor-glint screenshot verifier self-test: PASS " + good);
    }
