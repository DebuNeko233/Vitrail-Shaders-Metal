...
/** Developer-only pixel verifier for the PHASE 7 weather fixture. */
public final class VerifyWeatherScreenshot {
    private VerifyWeatherScreenshot() {
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 1) {
            System.err.println("Usage: java tests/VerifyWeatherScreenshot.java <minecraft-screenshot.png>");
            System.exit(2);
        }
        ...
        System.out.println("Weather screenshot swatches: GREEN=" + counts.green()
                + " MAGENTA=" + counts.magenta() + " greenMinimum=" + counts.greenMinimum());
        if (!counts.passes()) {
            throw new AssertionError("Expected visible green rain/snow curtain pixels and no substantial magenta PARTICLE-ABI failure region");
        }
        System.out.println("Weather screenshot routing/vertex-ABI colour check: PASS");
    }
    ...
    private static void selfTest() {
        ...
        fill(pass, 110, 45, 370, 285, 0xFF00CC00);
        ...
        fill(fail, 110, 45, 370, 285, 0xFFFF00FF);
        ...
        if (absent.passes()) throw new AssertionError("Verifier missing-weather self-test unexpectedly passed: " + absent);

        System.out.println("Weather screenshot verifier self-test: PASS " + good);
    }
