...
that one depends on the order its bucket was filled in, and on the quads where both engines do
substitute, the two axes are not the same axis. Nothing in the graphics API forces
any of it.
